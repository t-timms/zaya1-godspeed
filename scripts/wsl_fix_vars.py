...
c = c.replace(
    'x_q, x_s, x_zp, x_gs = layer.weight_packed, layer.weight_scale, None, getattr(layer, "weight_global_scale", None)',
    "x_q, x_s, x_zp, x_gs = weight, weight_scale, None, weight_global_scale",
)
c = c.replace(
